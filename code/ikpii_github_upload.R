...
# Run this script from the repository root (the folder containing README.md).
# No machine-specific setwd() is required.
# -------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
write.csv(annual, file.path(OUTPUT_DIR,file.path(OUTPUT_DIR, "ikpii_annual_scores.csv")), row.names=FALSE)
write.csv(target_df, file.path(OUTPUT_DIR,file.path(OUTPUT_DIR, "ragr_cagr_diagnostic.csv")), row.names=FALSE)
write.csv(equity_raw, file.path(OUTPUT_DIR,file.path(OUTPUT_DIR, "equity_selected_years.csv")), row.names=FALSE)
write.csv(scenario_df, file.path(OUTPUT_DIR,file.path(OUTPUT_DIR, "scenario_projections.csv")), row.names=FALSE)
write.csv(sensitivity, file.path(OUTPUT_DIR,file.path(OUTPUT_DIR, "sensitivity_appendixA.csv")), row.names=FALSE)
write.csv(worked, file.path(OUTPUT_DIR,file.path(OUTPUT_DIR, "worked_examples.csv")), row.names=FALSE)
writeLines(checks, file.path(OUTPUT_DIR,file.path(OUTPUT_DIR, "validation_checks.txt")))
